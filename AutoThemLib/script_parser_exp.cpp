...
enum
{
	...
	M_APPDATACOMMONDIR,
	M_DESKTOPCOMMONDIR,
	M_DOCUMENTSCOMMONDIR,
	M_FAVORITESCOMMONDIR,
	M_PROGRAMSCOMMONDIR,
	M_STARTMENUCOMMONDIR,
	M_STARTUPCOMMONDIR,
	M_APPDATADIR, 
	M_DESKTOPDIR,
	M_FAVORITESDIR, 
...
AUT_RESULT AutoIt_Script::Parser_EvaluateMacro(const char *szName, Variant &vResult)
{
	...
	wchar_t		szValue_w_tmp2[_MAX_PATH + 1] = { 0 };
	int			i = 0;
	struct		tm *newtime;
    time_t		long_time;
	DWORD		dwTemp;
	...
	switch (i)
	{
		...
		case M_AUTOITVERSION:
			GetModuleFileNameW (g_hInstance, szValue_w_tmp1, sizeof(szValue_w_tmp1));
			Util_GetFileVersion(szValue_w_tmp1, szValue_w_tmp2);
			vResult = szValue_w_tmp2;
			break;

		case M_AUTOITEXE:
			GetModuleFileNameW(NULL, szValue_w_tmp1, sizeof(szValue_w_tmp1));
			vResult = szValue_w_tmp1;
			break;
		...
		case M_INETGETACTIVE:
			...
			break;
		case M_AUTOITPID:
			vResult = (int)GetCurrentProcessId();
			break;
		case M_AUTOITX64:
			if (sizeof(LPVOID) == 4)
				vResult = 0;
