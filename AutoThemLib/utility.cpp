...
{
	wchar_t szTitle[256+1];						// Max message is 256 characters
	wchar_t szText[256+1];							// Max message is 256 characters

	LoadStringW(GetModuleHandleW(NULL), iErrTitle, szTitle, 256);
	LoadStringW(GetModuleHandleW(NULL), iErrMsg, szText, 256);
	MessageBoxW(hWnd, szText, szTitle, MB_ICONSTOP | MB_OK | MB_SYSTEMMODAL | MB_SETFOREGROUND);
...
{
	MessageBoxA(hWnd, szText, szTitle, MB_ICONSTOP | MB_OK | MB_SYSTEMMODAL | MB_SETFOREGROUND);
